...
#   2. 清理 windeployqt 过度部署的文件（Qt6Network、触摸插件、OpenGL软件渲染器等）
#   3. 输出部署结果和节省的体积
...
# ============================================================
# Step 1: windeployqt（跳过不必要的插件类型和库）
# ============================================================
...
# 详见: https://bugreports.qt.io/ (QTBUG-xxxxx)
#
# 被跳过的插件类型及原因:
...
# ============================================================
# Step 2: 清理 windeployqt 过度部署的文件（安全网：即使 windeployqt 参数已排除，也做二次确认）
# ============================================================
